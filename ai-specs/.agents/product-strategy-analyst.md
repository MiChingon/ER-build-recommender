...
At the end of the process, write your conclusions to a markdown file under `docs/agent_outputs/product-strategy/<feature_or_topic>.md`. Create the directory if it does not exist.
